...
import com.example.auth_service.dto.ApiKeyCreateRequestDTO;
import com.example.auth_service.dto.ApiKeyResponseDTO;
import com.example.auth_service.entity.ApiKey;
import com.example.auth_service.repository.ApiKeyRepository;
...
public class ApiKeyService {
    ...
    public List<ApiKeyResponseDTO> getAll() {
        return
                apiKeyRepository.findAll().stream().map(this::toDTO).collect(Collectors.toList());
    }
    ...
    private String generateRandomKey() {
        ...
        // Tiền tố "crs_" giúp dễ nhận diện đây là key của hệ thống CRS khi đọc log
